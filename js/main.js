...
const translations = {
    ru: {
        ...
        'proj.fitbody.desc': 'Фитнес-приложение с AI-трекером калорий, сканером штрихкодов и персональными планами питания',
        'proj.dream.tag': 'Социальная платформа',
        'proj.dream.desc': 'Платформа для визуализации целей и мечт с социальным взаимодействием',
    ...
    en: {
        ...
        'proj.fitbody.desc': 'Fitness app with AI calorie tracker, barcode scanner and personalized nutrition plans',
        'proj.dream.tag': 'Social platform',
        'proj.dream.desc': 'Platform for visualizing goals and dreams with social interaction',
