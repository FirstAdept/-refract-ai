...
const translations = {
    ru: {
        ...
        'case.mng.t': 'М—ЕРИЛО — система «Многогранников»',
        'case.mng.d': 'Все данные компании жили в пятнадцати таблицах — теперь в одной системе: восемь разделов с живыми цифрами. Принцип «зеркала»: система читает и сверяет, ваши таблицы не трогает. Доступ по ролям, тест — с 1 сентября.',
        'case.mng.m1': '11 листов',
        'case.mng.m2': 'система в тесте',
        'case.mng.m3': 'сентябрь 2026',
    ...
    en: {
        ...
        'case.mng.t': 'MERILO — the Mnogogranniki system',
        'case.mng.d': 'All company data lived in fifteen spreadsheets — now in one system: eight sections with live figures. The mirror principle: it reads and cross-checks, your spreadsheets stay untouched. Role-based access, testing from September 1.',
        'case.mng.m1': '11 sheets',
        'case.mng.m2': 'in testing',
        'case.mng.m3': 'September 2026',
